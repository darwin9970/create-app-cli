...
#### 介绍
antd前端移动框架，node环境V18+，使用更高版本出现问题，可降至V18；搭建时使用的版本20.11.0

#### 软件架构
软件架构采用：vue3+ant+vite+axios+pinia+sass+typescript
1. vue3：web开发框架 https://cn.vuejs.org/
2. axios：https://www.axios-http.cn/docs/api_intro
3. antd：https://www.antdv.com/components/config-provider-cn
4. pinia：https://pinia.vuejs.org/zh/
5. sass：https://blog.csdn.net/randy521520/article/details/131242242
6. typescript：https://blog.csdn.net/randy521520/article/details/130425863
